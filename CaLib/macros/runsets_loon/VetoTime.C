// SVN Info: $Id: VetoTime.C 912 2011-05-18 22:09:17Z werthm $
...
void VetoTime()
{
    ...
    const Char_t* fLoc = "/home/dpaudyal/output/";
    ...
    // create histogram
    gHOverview = new TH1F("CaLib_Veto_Time", "CaLib_Veto_Time", 40000, 0, 40000);
    ...
    TFile* fout = new TFile("runset_overviewVetoTime.root", "recreate");
    cOverview->Write();
    delete fout;
