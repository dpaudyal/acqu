...
Char_t Buffer[256];
///////////////////////////////////////////////////////////////////////////////
//TFile *ffore=new TFile("/home/dpaudyal/acqu/acqu_user/TaggEff.root");

//TFile *fback1=new TFile("/home/dpaudyal/acqu/acqu_user/TaggEff_back1.root");
//TFile *fback2=new TFile("/home/dpaudyal/acqu/acqu_user/TaggEff_back2.root");



void TaggEffdilli(){
  TaggEff1("/home/dpaudyal/TaggEffcarbon_output/set5/ARHistograms_back1.root","/home/dpaudyal/TaggEffcarbon_output/set5/ARHistograms.root","/home/dpaudyal/TaggEffcarbon_output/set5/ARHistograms_back2.root",352,1,1);
  TaggEffDraw(350);
...
//void TaggEff1(Char_t* fback1, Char_t* ffore, Char_t* fback2,
//        Int_t nchan=352, Int_t jclk=1, Int_t jinh=1)
void TaggEff1(Char_t* fback1  , Char_t* ffore, Char_t* fback2, Int_t nchan, Int_t jclk, Int_t jinh)
{
...
// calculate tagging efficiency
  ...
  histScB2 = (TH1D*)back2->Get("FPD_ScalerAcc");
  histSB2 = (TH1D*)back2->Get("SumScalers0to11");
...
///////////////////////////////////////////////////////
TaggEffPlot->GetYaxis()->SetRange(0,1);
///////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////
TaggEffPlotB->GetYaxis()->SetRange(0,1);
///////////////////////////////////////////////////////
